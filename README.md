...
The same data anchors a rank. Every skill sits at a curriculum stage of the Swiss ladder — Sek, BM/FH, Passerelle, university entrance — a skill counts as secured at 70% mastery on real evidence, and six ranks, Apprentice to Grandmaster, gate on how much of each stage you hold: the rank in the corner literally answers where you stand between school and university. Placement is fast because every solved problem also updates one global ability estimate that fills in expectations for skills you have not shown yet; securing them is the slow, earned part. Secured skills decay when left unpractised, so a rank is held, not owned.
